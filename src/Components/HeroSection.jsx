                    ...
                    <div className=" mx-auto grid grid-cols-1 mt-5 md:mt-20 mb-20 md:mb-0 md:grid-cols-2 gap-12 ">
                        <div className="space-y-4  mt-30 justify-center">
                            ...
                            <p className="text-lg md:text-xl text-muted-forground max-w-2xl opacity-0 animate-fade-in-delay-3">
                                I am Full-Stack Developer with hands-on experience building web and mobile applications using Node.js, 
                                Next.js, React, Flutter, and PostgreSQL. Skilled in designing RESTful APIs, implementing secure 
                                authentication systems, integrating payment gateways, and optimizing user experience.  </p>
                        </div>
